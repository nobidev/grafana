...
import { getDataSourceByUid, convertK8sDatasourceSettingsToLegacyDatasourceSettings, DataSourceSettingsK8s, K8sMetadata, DatasourceInstanceK8sSpec } from './api';
...
describe('Datasources / API', () => {
  ...
  describe('convertLegacyDatasourceToK8sDatasource()', () => {
    it('should convert legacy datasource to k8s datasource', () => {
      ...
      labels.set('grafana.app/deprecatedInternalID', '42');
