    ...
    if (logsDataSourceSettings && traceToLogsOptions) {
      ...
      if (query) {
        ...
        if (getVariableUsageInfo(dataLink.internal!.query, scopedVars).allVariablesDefined) {
          ...
          // Run post-processor manually as we don't have the link in the DataFrame
          // Once legacy links are migrated this will happen in field.getLinks()
          link =
            (dataFrame &&
              dataLinkPostProcessor?.({
                frame: dataFrame,
