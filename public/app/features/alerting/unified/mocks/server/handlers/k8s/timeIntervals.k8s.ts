...
import { ComGithubGrafanaGrafanaAppsAlertingNotificationsPkgApisAlertingV0Alpha1TimeInterval } from 'app/features/alerting/unified/openapi/timeIntervalsApi.gen';
...
const allTimeIntervals =
  getK8sResponse<ComGithubGrafanaGrafanaAppsAlertingNotificationsPkgApisAlertingV0Alpha1TimeInterval>(
    'TimeIntervalList',
    [
      {
        metadata: {
