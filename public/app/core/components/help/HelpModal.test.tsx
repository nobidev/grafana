...
describe('useShortcuts', () => {
  ...
  describe('time range zoom shortcuts with feature toggle', () => {
    ...
    it('should show new zoom shortcuts when feature toggle is enabled', () => {
      ...
      const resetShortcut = timeRangeCategory!.shortcuts.find((s) => s.keys.includes('t') && s.keys.includes('0'));
      ...
      expect(resetShortcut).toBeDefined();
      expect(resetShortcut!.isNew).toBe(true);
    });
    ...
    it('should show legacy t z shortcut when feature toggle is disabled', () => {
      ...
      expect(resetShortcut).toBeUndefined();
    });
