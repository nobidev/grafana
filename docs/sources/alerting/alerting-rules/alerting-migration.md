...
9. (Optional) In the **Target data source** of the **Recording rules** section, you can select the target data source for the imported recording rules. By default, it is the data source selected in the **Data source** dropdown.
