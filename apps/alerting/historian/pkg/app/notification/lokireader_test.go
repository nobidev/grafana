...
func TestGroupAlerts(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "different timestamps - separate notifications",
			entries: []Entry{
				{
					Timestamp:    now,
					GroupKey:     "group1",
		...
		},
		{
			...
			entries: []Entry{
				// Notification 1: group1, time1, pipeline1 (2 alerts)
				{
					Timestamp:    now,
					GroupKey:     "group1",
					PipelineTime: pipelineTime,
				...
				// Notification 2: group2, time1, pipeline1 (1 alert)
				{
					Timestamp:    now,
					GroupKey:     "group2",
					PipelineTime: pipelineTime,
				...
				// Notification 3: group1, time2, pipeline1 (1 alert)
				{
