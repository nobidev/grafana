...
func TestIsValidKey(t *testing.T) {
	tests := []struct {
		...
		{"user-storage key with colon (kvtest reproduction)",
			"userstorage.grafana.app/user-storage/default/grafana-splash-screen:afgzow84sv3lsf/2052318477101322240~created~", true},
