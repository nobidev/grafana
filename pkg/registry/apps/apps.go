...
import (
	...
	"github.com/grafana/grafana/pkg/registry/apps/alerting/adminconfig"
...
func ProvideAppInstallers(
	...
	alertingAdminConfigAppInstaller *adminconfig.AppInstaller,
	...
	if alertingAdminConfigAppInstaller != nil {
		installers = append(installers, alertingAdminConfigAppInstaller)
	}
