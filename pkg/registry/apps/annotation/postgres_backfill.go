...
// recordTimeEnd is the stored time_end: a point's end is its own time.
func recordTimeEnd(rec migrator.BackfillRecord) int64 {
	if rec.TimeEnd != nil {
		return *rec.TimeEnd
	}
	return rec.Time
