	...
	standardFeatureFlags = []FeatureFlag{
		{
			...
			Expression:  "false",
			Generate:    []GenerateTarget{GenerateLegacyGo, GenerateLegacyFrontend},
		},
		{
		...
		},
		{
			...
			Stage:       FeatureStageExperimental,
			Generate:    []GenerateTarget{GenerateLegacyFrontend},
		...
		},
		{
			...
			Stage:       FeatureStageExperimental,
			Generate:    []GenerateTarget{GenerateLegacyFrontend, GenerateReact},
		...
		},
		{
			...
			Owner:           grafanaAppPlatformSquad,
			Expression:      "true",
			Generate:        []GenerateTarget{GenerateLegacyGo, GenerateReact},
		},
		{
		...
		},
		{
			...
			Stage:       FeatureStageExperimental,
			Owner:       grafanaDatasourcesCoreServicesSquad,
			Generate:    []GenerateTarget{GenerateLegacyFrontend}, // and can change at startup
			Expression:  "false",
		},
		{
		...
		},
		{
			...
			Stage:       FeatureStageGeneralAvailability,
			Generate:    []GenerateTarget{GenerateLegacyGo, GenerateLegacyFrontend}, // The restore backend feature changes behavior based on this flag
			Owner:       grafanaDashboardsSquad,
			Expression:  "true",
		},
		{
		...
		},
		{
			...
			Stage:       FeatureStageExperimental,
			Owner:       grafanaSharingSquad,
			Generate:    []GenerateTarget{GenerateLegacyFrontend, GenerateReact}, // legacy frontend for old naming convention
			Expression:  "false",
		},
		{
		...
		},
		{
			...
			Stage:       FeatureStageExperimental,
			Owner:       grafanaAlertingSquad,
			Generate:    []GenerateTarget{GenerateLegacyGo, GenerateLegacyFrontend}, // changes navtree from backend
			Expression:  "false",
		},
		{
		...
		},
		{
			...
			Generate:     []GenerateTarget{GenerateLegacyGo, GenerateLegacyFrontend}, // changes navtree from the backend
			Stage:        FeatureStageGeneralAvailability,
			Owner:        grafanaAlertingSquad,
			HideFromDocs: true,
			Expression:   "true", // enabled by default
		...
		},
		{
			...
			Stage:        FeatureStageExperimental,
			Generate:     []GenerateTarget{GenerateLegacyGo, GenerateLegacyFrontend}, // changes navtree in backend
			Owner:        grafanaAlertingSquad,
			HideFromDocs: true,
			Expression:   "false",
		},
		...
		},
		{
			...
			Stage:       FeatureStageExperimental,
			Generate:    []GenerateTarget{GenerateReact},
			Owner:       grafanaFrontendPlatformSquad,
			Expression:  "false",
		},
		{
