...
require (
	...
	github.com/grafana/grafana-app-sdk v0.48.5 // @grafana/grafana-app-platform-squad
...
require github.com/grafana/grafana/apps/quotas v0.0.0-20251209161505-319789209410 // @grafana/grafana-search-and-storage
