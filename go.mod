...
require (
	...
	github.com/grafana/authlib v0.0.0-20260409220714-9b5cc084c9fd // @grafana/identity-access-team
	github.com/grafana/authlib/types v0.0.0-20260409220714-9b5cc084c9fd // @grafana/identity-access-team
